...
CONST(Gpt_ConfigType, GPT_CONST)  Gpt_Config =
{
    ...
    /*Hardware to logic channel mapping.*/
    {
        ...
        GptConf_GptChannelConfiguration_FTM3_CH0, /*mapping of FTM_3_CH_0*/
        ...
        GptConf_GptChannelConfiguration_LPIT0_CH0, /*mapping of LPIT_0_CH_0*/
        GptConf_GptChannelConfiguration_LPIT0_CH1, /*mapping of LPIT_0_CH_1*/
        GptConf_GptChannelConfiguration_LPIT0_CH2, /*mapping of LPIT_0_CH_2*/
