...
/**
* @brief          Symbolic name for the channel Rear_SignalL.
*
*/


/** @violates @ref Dio_Cfg_H_REF_1 The used compilers use more than 31 chars for identifiers. */
#define  DioConf_DioChannel_Rear_SignalL ((uint16)0x0063U)

/**
* @brief          Symbolic name for the channel Rear_SignalR.
*
*/


/** @violates @ref Dio_Cfg_H_REF_1 The used compilers use more than 31 chars for identifiers. */
#define  DioConf_DioChannel_Rear_SignalR ((uint16)0x0062U)

/**
* @brief          Symbolic name for the channel Reverse_L.
*
*/


/** @violates @ref Dio_Cfg_H_REF_1 The used compilers use more than 31 chars for identifiers. */
#define  DioConf_DioChannel_Reverse_L ((uint16)0x0065U)

/**
* @brief          Symbolic name for the channel Brake_L.
*
*/


/** @violates @ref Dio_Cfg_H_REF_1 The used compilers use more than 31 chars for identifiers. */
#define  DioConf_DioChannel_Brake_L ((uint16)0x006cU)

/**
* @brief          Symbolic name for the channel Brake_R.
*
*/


/** @violates @ref Dio_Cfg_H_REF_1 The used compilers use more than 31 chars for identifiers. */
#define  DioConf_DioChannel_Brake_R ((uint16)0x0061U)
...
/**
* @brief          Symbolic name for the channel Front_SignalL.
*
*/


/** @violates @ref Dio_Cfg_H_REF_1 The used compilers use more than 31 chars for identifiers. */
#define  DioConf_DioChannel_Front_SignalL ((uint16)0x000eU)

/**
* @brief          Symbolic name for the channel Head_L.
*
*/


/** @violates @ref Dio_Cfg_H_REF_1 The used compilers use more than 31 chars for identifiers. */
#define  DioConf_DioChannel_Head_L ((uint16)0x0011U)
...
/**
* @brief          Symbolic name for the channel Sw_SignalL.
*
*/


/** @violates @ref Dio_Cfg_H_REF_1 The used compilers use more than 31 chars for identifiers. */
#define  DioConf_DioChannel_Sw_SignalL ((uint16)0x004cU)

/**
* @brief          Symbolic name for the channel Sw_SignalR.
*
*/


/** @violates @ref Dio_Cfg_H_REF_1 The used compilers use more than 31 chars for identifiers. */
#define  DioConf_DioChannel_Sw_SignalR ((uint16)0x004dU)

/**
* @brief          Symbolic name for the channel Head_R.
*
*/


/** @violates @ref Dio_Cfg_H_REF_1 The used compilers use more than 31 chars for identifiers. */
#define  DioConf_DioChannel_Head_R ((uint16)0x0051U)
...
/**
* @brief          Symbolic name for the channel Front_SignalR.
*
*/


/** @violates @ref Dio_Cfg_H_REF_1 The used compilers use more than 31 chars for identifiers. */
#define  DioConf_DioChannel_Front_SignalR ((uint16)0x0087U)

/**
* @brief          Symbolic name for the channel Reverse_R.
*
*/


/** @violates @ref Dio_Cfg_H_REF_1 The used compilers use more than 31 chars for identifiers. */
#define  DioConf_DioChannel_Reverse_R ((uint16)0x0083U)
