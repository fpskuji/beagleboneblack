...
#define CAN_SW_PATCH_VERSION_C               4
    ...
    else
    {
        ...
        else
        {
            ...
            else
            {
                ...
                {
                    /* @violates @ref Can_c_REF_9 Violates MISRA 2004 Required Rule 10.1 , Prohibited Implicit Conversion: Non-constant argument to function, Implicit conversion of integer to smaller type */
                    /* @violates @ref Can_c_REF_10 Violates MISRA 2004 Required Rule 12.10, The comma is used to abstract the trusted call function and to determine when the return into user mode is needed */
                    Can_IPW_SetBaudrate(Controller);
                }
#if (CAN_DEV_ERROR_DETECT == STD_ON)
            }
        }
