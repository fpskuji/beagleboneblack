...
void LED_Control(uint16 Can_Data)
{
    ...
    {
        Dio_WriteChannel(DioConf_DioChannel_Front_SignalL, STD_HIGH);
        Dio_WriteChannel(DioConf_DioChannel_Rear_SignalL, STD_HIGH);
    }
    ...
    {
        Dio_WriteChannel(DioConf_DioChannel_Front_SignalR, STD_HIGH);
        Dio_WriteChannel(DioConf_DioChannel_Rear_SignalR, STD_HIGH);
    }
    ...
    {
        Dio_WriteChannel(DioConf_DioChannel_Reverse_L, STD_HIGH);
        Dio_WriteChannel(DioConf_DioChannel_Reverse_R, STD_HIGH);
    }
