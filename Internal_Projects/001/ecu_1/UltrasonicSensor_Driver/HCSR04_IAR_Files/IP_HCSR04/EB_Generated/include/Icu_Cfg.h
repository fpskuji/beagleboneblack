...
#define IcuFtm2_Ch0                     (IcuConf_IcuChannel_IcuFtm2_Ch0)
#define IcuConf_IcuChannel_IcuFtm2_Ch0  ((Icu_ChannelType)2U) 
...
/**
*   @brief ISR's configured for FTM_2 channels
*   @details Macros for channels used in ISR
*/
#define ICU_FTM_2_CH_0_CH_1_ISR_USED 
...
/**
 *   @brief ISR's configured for FTM_2
 *   @details Macros for channels used in ISR
 */
#define ICU_FTM_2_USED
