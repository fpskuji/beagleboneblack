...
/* Check if source file and Mcl_FlexIO_Common.h header file are of the same Autosar version */
    ...
    #error "AutoSar Version Numbers of Mcl_FlexIO_Common.c and Mcl_FlexIO_Common.h are different"
#endif
/* Check if source file and Mcl_FlexIO_Common.h header file are of the same software version */
    ...
    #error "Software Version Numbers of Mcl_FlexIO_Common.c and Mcl_FlexIO_Common.h are different"
#endif
...
/* Check if source file and StdRegMacros header file are of the same Autosar version */
         ...
         (FLEXIO_COMMON_AR_RELEASE_MINOR_VERSION_C != STDREGMACROS_AR_RELEASE_MINOR_VERSION) \
            ...
            #error "AutoSar Version Numbers of Mcl_FlexIO_Common.c and StdRegMacros.h are different"
    #endif
#endif

/* Check if source file and SchM_Mcl header file are of the same Autosar version */
#ifndef DISABLE_MCAL_INTERMODULE_ASR_CHECK
    #if ((FLEXIO_COMMON_AR_RELEASE_MAJOR_VERSION_C != SCHM_MCL_AR_RELEASE_MAJOR_VERSION) || \
         (FLEXIO_COMMON_AR_RELEASE_MINOR_VERSION_C != SCHM_MCL_AR_RELEASE_MINOR_VERSION) \
        )
            #error "AutoSar Version Numbers of Mcl_FlexIO_Common.c and SchM_Mcl.h are different"
    #endif
#endif

#ifndef DISABLE_MCAL_INTERMODULE_ASR_CHECK
    #if ((FLEXIO_COMMON_AR_RELEASE_MAJOR_VERSION_C != STD_AR_RELEASE_MAJOR_VERSION) || \
         (FLEXIO_COMMON_AR_RELEASE_MINOR_VERSION_C != STD_AR_RELEASE_MINOR_VERSION) \
        )
            #error "AutoSar Version Numbers of Mcl_FlexIO_Common.c and Std_Types.h are different"
    #endif
#endif

/* Check if source file and CDD_Mcl_Cfg.h header file are of the same vendor */
#if (FLEXIO_COMMON_VENDOR_ID_C != MCL_VENDOR_ID_CFG)
    #error "Mcl_FlexIO_Common.c and CDD_Mcl_Cfg.h have different vendor ids"
#endif
/* Check if source file and CDD_Mcl_Cfg.h header file are of the same Autosar version */
#if ((FLEXIO_COMMON_AR_RELEASE_MAJOR_VERSION_C    != MCL_AR_RELEASE_MAJOR_VERSION_CFG) || \
     (FLEXIO_COMMON_AR_RELEASE_MINOR_VERSION_C    != MCL_AR_RELEASE_MINOR_VERSION_CFG) || \
     (FLEXIO_COMMON_AR_RELEASE_REVISION_VERSION_C != MCL_AR_RELEASE_REVISION_VERSION_CFG) \
    )
    #error "AutoSar Version Numbers of Mcl_FlexIO_Common.c and CDD_Mcl_Cfg.h are different"
#endif
/* Check if source file and Mcl_FlexIO_Common.h header file are of the same software version */
#if ((FLEXIO_COMMON_SW_MAJOR_VERSION_C != MCL_SW_MAJOR_VERSION_CFG) || \
     (FLEXIO_COMMON_SW_MINOR_VERSION_C != MCL_SW_MINOR_VERSION_CFG) || \
     (FLEXIO_COMMON_SW_PATCH_VERSION_C != MCL_SW_PATCH_VERSION_CFG) \
    )
    #error "Software Version Numbers of Mcl_FlexIO_Common.c and CDD_Mcl_Cfg.h are different"
#endif

/* Check if source file and Reg_eSys_FlexIO.h header file are of the same vendor */
#if (FLEXIO_COMMON_VENDOR_ID_C != REG_ESYS_FLEXIO_VENDOR_ID)
    #error "Mcl_FlexIO_Common.c and Reg_eSys_FlexIO.h have different vendor ids"
#endif
/* Check if source file and Reg_eSys_FlexIO.h header file are of the same Autosar version */
#if ((FLEXIO_COMMON_AR_RELEASE_MAJOR_VERSION_C    != REG_ESYS_FLEXIO_AR_RELEASE_MAJOR_VERSION) || \
     (FLEXIO_COMMON_AR_RELEASE_MINOR_VERSION_C    != REG_ESYS_FLEXIO_AR_RELEASE_MINOR_VERSION) || \
     (FLEXIO_COMMON_AR_RELEASE_REVISION_VERSION_C != REG_ESYS_FLEXIO_AR_RELEASE_REVISION_VERSION) \
    )
    #error "AutoSar Version Numbers of Mcl_FlexIO_Common.c and Reg_eSys_FlexIO.h are different"
#endif
/* Check if source file and Mcl_FlexIO_Common.h header file are of the same software version */
#if ((FLEXIO_COMMON_SW_MAJOR_VERSION_C != REG_ESYS_FLEXIO_SW_MAJOR_VERSION) || \
     (FLEXIO_COMMON_SW_MINOR_VERSION_C != REG_ESYS_FLEXIO_SW_MINOR_VERSION) || \
     (FLEXIO_COMMON_SW_PATCH_VERSION_C != REG_ESYS_FLEXIO_SW_PATCH_VERSION) \
    )
    #error "Software Version Numbers of Mcl_FlexIO_Common.c and Reg_eSys_FlexIO.h are different"
#endif
...
VAR(Mcl_FlexIOInitType, MCL_VAR) Mcl_FlexIO_InitStatus = MCL_FLEXIO_UNINITIALIZED;
...
{
    Mcl_FlexIO_InitStatus = MCL_FLEXIO_INITIALIZED;
...
{
    Mcl_FlexIO_InitStatus = MCL_FLEXIO_UNINITIALIZED;
