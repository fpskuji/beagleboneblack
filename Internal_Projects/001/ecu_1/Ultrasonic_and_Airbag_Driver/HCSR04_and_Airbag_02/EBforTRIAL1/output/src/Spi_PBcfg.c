...
static VAR(Spi_Ipw_LPspiDeviceAttributesConfigType, SPI_VAR) LPspiDeviceAttributesConfig_PB[1] =
{
                
        {
          ...
          | 
            ...
            ( ((uint32)(0) << 24u) | /* TimeClk2Cs: Should=1000ns, Is=1000, Error=0.0% */
            ((uint32)(0) << 16u) | /* TimeCs2Clk: Should=1000ns, Is=1000, Error=0.0% */
            ((uint32)(0) << 8u) | /* TimeCs2Cs: Should=1000ns, Is=1000, Error=0.0% */
            ((uint32)(8))
            ),

/* CFG1 register configuration */
                LPSPI_CFGR1_PCS0_IDLELOW_U32  /* Chip select polarity */
...
static CONST(Spi_ChannelConfigType, SPI_CONST) SpiChannelConfig_PB[1] =
{
    {
        /* CH0*/
        IB,
...
static CONST(Spi_JobConfigType, SPI_CONST) SpiJobConfig_PB[1] =
{
    {
        ...
        CSIB0, /* HWUnit index */
        LPSPI_2_OFFSET, /* LPspi device HW unit offset */
...
static CONST(Spi_SequenceConfigType, SPI_CONST) SpiSequenceConfig_PB[1] =
{
    {  /* SpiSequence_0 */
...
* signifiance and case sensitivity are supported for external identifiers.
*/
static CONST(Spi_Ipw_LPspiChannelAttributesConfigType, SPI_CONST) LPspiChannelAttributesConfig_PB[1] =
{
{ 
