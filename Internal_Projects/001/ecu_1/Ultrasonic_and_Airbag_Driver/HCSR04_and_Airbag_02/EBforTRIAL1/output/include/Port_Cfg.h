...
#define PortConfigSet_SPI_PINS_LPSPI2_SCK  0
/** @violates @ref PORT_CFG_H_REF_1 The used compilers use more than 31 chars for identifiers. */
#define PortConfigSet_SPI_PINS_LPSPI2_SOUT  1
/** @violates @ref PORT_CFG_H_REF_1 The used compilers use more than 31 chars for identifiers. */
#define PortConfigSet_SPI_PINS_LPSPI2_SIN  2
/** @violates @ref PORT_CFG_H_REF_1 The used compilers use more than 31 chars for identifiers. */
#define PortConfigSet_SPI_PINS_LPSPI2_PCS0  3
