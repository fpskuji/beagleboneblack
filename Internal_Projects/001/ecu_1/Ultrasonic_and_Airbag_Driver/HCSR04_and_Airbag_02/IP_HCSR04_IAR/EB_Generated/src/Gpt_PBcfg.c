...
extern void Gpt_NotificationFTM3_CH0(void);
/** @violates @ref GPT_PBCFG_C_REF_5 External variables and functions should only appear in one file*/
extern void Gpt_NotificationFTM2_CH0(void);
/** @} */
...
static CONST(Gpt_ChannelConfigType, GPT_CONST) Gpt_InitChannelPB[4] =
{
    {   /*LPIT_0_CH_0 configuration data*/
...
,
    {   /*LPIT_0_CH_1 configuration data*/
        (boolean)FALSE, /* Wakeup capability */
        NULL_PTR, /* Channel notification */
#if ((GPT_WAKEUP_FUNCTIONALITY_API == STD_ON) && (GPT_REPORT_WAKEUP_SOURCE == STD_ON))
        (EcuM_WakeupSourceType)0U, /* Wakeup information */
...
,
    {   /*FTM_3_CH_0 configuration data*/
        (boolean)FALSE, /* Wakeup capability */
        &Gpt_NotificationFTM3_CH0, /* Channel notification */
#if ((GPT_WAKEUP_FUNCTIONALITY_API == STD_ON) && (GPT_REPORT_WAKEUP_SOURCE == STD_ON))
        (EcuM_WakeupSourceType)0U, /* Wakeup information */
#endif
        ...
        (Gpt_ChannelModeType)(GPT_CH_MODE_CONTINUOUS), /* Timer mode:continous/one-shot */
        {
            (uint8)(FTM_3_CH_0), /* GPT physical channel no. */
...
#if (GPT_LPIT_ENABLE_EXT_TRIGGERS==STD_ON)
            /* LPIT External/Internal Trigger Configuration */
            (uint32)0U,             /* Not used for FTM_3_CH_0 */
#endif
#if (GPT_CHAIN_MODE == STD_ON)
...
,
    {   /*FTM_2_CH_0 configuration data*/
        (boolean)FALSE, /* Wakeup capability */
        &Gpt_NotificationFTM2_CH0, /* Channel notification */
#if ((GPT_WAKEUP_FUNCTIONALITY_API == STD_ON) && (GPT_REPORT_WAKEUP_SOURCE == STD_ON))
        (EcuM_WakeupSourceType)0U, /* Wakeup information */
#endif
        (Gpt_ValueType)(65535U), /* Maximum ticks value*/
        (Gpt_ChannelModeType)(GPT_CH_MODE_CONTINUOUS), /* Timer mode:continous/one-shot */
        {
            (uint8)(FTM_2_CH_0), /* GPT physical channel no. */
            (uint8)(GPT_FTM_MODULE), /* hardware module ID */
            (boolean)TRUE, /* Freeze Enable */
            (uint8)(3U), /* FTM clock source */
            (Gpt_PrescalerType)(0U), /* FTM Clock divider */ 
...
#if (GPT_LPIT_ENABLE_EXT_TRIGGERS==STD_ON)
            /* LPIT External/Internal Trigger Configuration */
            (uint32)0U,             /* Not used for FTM_2_CH_0 */
#endif
#if (GPT_CHAIN_MODE == STD_ON)
...
CONST(Gpt_ConfigType, GPT_CONST)  Gpt_Config =
{
    ...
    /*Hardware to logic channel mapping.*/
    {
        ...
        GptConf_GptChannelConfiguration_FTM_2_CH_0, /*mapping of FTM_2_CH_0*/
        ...
        GptConf_GptChannelConfiguration_FTM_3_CH_0, /*mapping of FTM_3_CH_0*/
        ...
        GptConf_GptChannelConfiguration_LPIT_0_CH_0, /*mapping of LPIT_0_CH_0*/
        GptConf_GptChannelConfiguration_LPIT_0_CH_1, /*mapping of LPIT_0_CH_1*/
