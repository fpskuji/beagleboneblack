 ...
 */
 CONST(Icu_ChannelConfigType, ICU_CONST) Icu_InitChannel_PB[2]=
 {
         /* IcuFtm0_Ch0*/
        {
 ...
 */
 CONST(Icu_Ftm_ChannelConfigType, ICU_CONST) Icu_Ftm_ChannelConfig_PB[2] =
 {
 ...
 * @violates @ref Icu_PBCfg_c_3 violates Misra 8.10 external ... could be made static
 */
 CONST(Icu_IpChannelConfigType, ICU_CONST) Icu_IpChannelConfig_PB[2] =
 {
...
CONST(Icu_ChannelType,ICU_CONST) Icu_InitHWMap_PB[ICU_MAX_HW_CHANNELS] =
{
    ...
    ICU_NOICUCHANNEL, /* maps to FTM_2_CH_0 */
...
{
    (Icu_ChannelType)2U, /* The number of channels configured*/
    &Icu_InitChannel_PB,
    {
