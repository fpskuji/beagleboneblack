...
/**
* @brief          Symbolic name for the channel Forward.
*
*/


/** @violates @ref Dio_Cfg_H_REF_1 The used compilers use more than 31 chars for identifiers. */
#define  DioConf_DioChannel_Forward ((uint16)0x0041U)

/**
* @brief          Symbolic name for the channel Reverse.
*
*/


/** @violates @ref Dio_Cfg_H_REF_1 The used compilers use more than 31 chars for identifiers. */
#define  DioConf_DioChannel_Reverse ((uint16)0x0042U)
