...
* external identifiers.
*/
#define SpiConf_SpiChannel_CH1    ((Spi_ChannelType)1)
...
* external identifiers.
*/
#define SpiConf_SpiChannel_CH2    ((Spi_ChannelType)2)
...
* external identifiers.
*/
#define SpiConf_SpiChannel_CH3    ((Spi_ChannelType)3)
...
* external identifiers.
*/
#define SpiConf_SpiSequence_SpiSequence_3   ((Spi_SequenceType)3)
...
#define SPI_TIMEOUT_COUNTER       ((sint32)((4000000u) / SPI_WAIT_LOOP_TICKS))
