...
#define MCL_LMEM_SW_PATCH_VERSION             4
/**@}*/
...
/* Check if source file and Mcl_Lmem_Types.h header file are of the same Autosar version */
     ...
     (MCL_LMEM_AR_RELEASE_REVISION_VERSION != MCL_LMEM_TYPES_AR_RELEASE_REVISION_VERSION) \
        )
        #error "AutoSar Version Numbers of Mcl_Lmem.h and Mcl_Lmem_Types.h are different"
#endif
/* Check if source file and Mcl_Lmem_Types.h header file are of the same vendor */
#if (MCL_LMEM_VENDOR_ID != MCL_LMEM_TYPES_VENDOR_ID)
    #error "Mcl_Lmem.h and Mcl_Lmem_Types.h have different vendor ids"
#endif
/* Check if source file and Mcl_Lmem_Types.h header file are of the same software version */
