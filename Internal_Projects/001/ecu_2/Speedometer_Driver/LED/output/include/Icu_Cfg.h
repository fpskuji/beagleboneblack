...
#define PTC15                     (IcuConf_IcuChannel_PTC15)
#define IcuConf_IcuChannel_PTC15  ((Icu_ChannelType)0U) 
#define PTD6                     (IcuConf_IcuChannel_PTD6)
#define IcuConf_IcuChannel_PTD6  ((Icu_ChannelType)1U) 
...
/**
*   @brief ISR's configured for FTM_3 channels
*   @details Macros for channels used in ISR
*/
#define ICU_FTM_3_CH_6_CH_7_ISR_USED 
...
/**
 *   @brief ISR's configured for FTM_3
 *   @details Macros for channels used in ISR
 */
#define ICU_FTM_3_USED
...
/**
*   @brief ISR's configured for PORT_3 channels
*   @details Macros for channels used in ISR
*/
#define ICU_PORT_3_ISR_USED 
