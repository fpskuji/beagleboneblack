...
/**
* @brief          Symbolic name for the port PTC15.
*
*/
#define DioConf_DioPort_PTC15  ((uint8)0x02U)

/**
* @brief          Symbolic name for the channel PTC15.
*
*/


/** @violates @ref Dio_Cfg_H_REF_1 The used compilers use more than 31 chars for identifiers. */
#define  DioConf_DioChannel_PTC15 ((uint16)0x004fU)
