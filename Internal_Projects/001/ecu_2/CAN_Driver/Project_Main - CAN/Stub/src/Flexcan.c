...
#define MSG_BUF_SIZE 4 /* Msg Buffer Size. (CAN 2.0AB: 2 hdr +  2 data= 4 words)*/
  ...
  CAN0->CTRL1 = 0
                ...
                | CAN_CTRL1_LPB(1);    /* Enable Loop Back Mode */
                                       /* PSEG1 = PSEG2 = 3 						*/
...
void FLEXCAN0_transmit_msg(uint32 Data)
{
  /*! Assumption:
   * =================================
  ...
  CAN0->RAMn[0 * MSG_BUF_SIZE + 2] = Data; /* MB0 word 2: data word 0 */
  CAN0->RAMn[0 * MSG_BUF_SIZE + 3] = (uint32)0; /* MB0 word 3: data word 1 */
#ifdef NODE_A
...
{
  /*! Receive msg from ID 0x556 using msg buffer 0
   * =============================================
   */
  uint8_t j;
  uint32_t dummy;
