...
extern void Gpt_Notification_FTM_2_CH_5(void);
/** @} */
...
static CONST(Gpt_ChannelConfigType, GPT_CONST) Gpt_InitChannelPB[1] =
{
    {   /*GptChannelConfiguration_0 configuration data*/
        ...
        &Gpt_Notification_FTM_2_CH_5, /* Channel notification */
        ...
        {
            (uint8)(FTM_2_CH_5), /* GPT physical channel no. */
            ...
            (uint32)0U,             /* Not used for FTM_2_CH_5 */
#endif
...
CONST(Gpt_ConfigType, GPT_CONST)  Gpt_Config =
{
    ...
    /*Hardware to logic channel mapping.*/
    {
        ...
        GptConf_GptChannelConfiguration_GptChannelConfiguration_0, /*mapping of FTM_2_CH_5*/
