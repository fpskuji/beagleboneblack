...
#define PWM_PBCFG_SW_PATCH_VERSION_C               4
/**@}*/
...
static CONST(Pwm_Ftm_ModuleConfigType, PWM_CONST) Pwm_Ftm_ModuleConfig_PB[PWM_FTM_MOD_CONFIGS_PB] =
{
    ...
    /* Ftm Module 0 */
    {
        ...
        (FTM_SC_CLKS_EXTERNAL_CLOCK_U32 | FTM_SC_PS_DIV8_U32 | ((uint32)1U << (FTM_SC_PWMOUTPUTEN_SHIFT + (uint32)3U ))| ((uint32)0)),
        ...
        /** @brief Default period value: , freq = 50.0 Hz: FTM_0_MOD register*/
        ((Pwm_PeriodType) 2500)
    ...
    /* Ftm Module 1 */
    {
        ...
        /** @brief FTM_3_SC register */
        (FTM_SC_CLKS_EXTERNAL_CLOCK_U32 | FTM_SC_PS_DIV1_U32 |  ((uint32)1U << (FTM_SC_PWMOUTPUTEN_SHIFT + (uint32)1U ))| ((uint32)1U << (FTM_SC_PWMOUTPUTEN_SHIFT + (uint32)0U ))| ((uint32)0)),


        /** @brief FTM_3_SYNC register */
        (uint8) ((FTM_SYNC_CNTMAX_ENABLE_U32 << FTM_SYNC_CNTMAX_SHIFT) | ((uint32) 0)),

        /** @brief FTM_3_MODE register used to enable other features of the FTM */
        (FTM_MODE_INIT_ENABLE_U32 | FTM_MODE_FTMEN_ENABLE_U32 | FTM_MODE_WPDIS_DISABLE_U32 | ((uint32)0)),

        /** @brief FTM_3_DEADTIME register */
        (FTM_DEADTIME_DTPS_DIV1_U32 | ((uint32) 0U)),

        /** @brief FTM_3_COMBINE register */
        (FTM_COMBINE_SYNCEN0_ENABLE_U32 | ((uint32) 0)),

         /** @brief Id of the referenced FTM module: FTM_3 */
        PWM_FTM_3,

        /** @brief Default period value: , freq = 1000.0 Hz: FTM_3_MOD register*/
        ((Pwm_PeriodType) 1000)

#if (PWM_FAULT_SUPPORTED == STD_ON)
        ,

        /** @brief FTM_3_FLTCTRL register */
        ((uint32) 0),

        /** @brief FTM_3_FLTPOL register */
        ((uint32) 0),
...
CONST(Pwm_ConfigType, Pwm_CONST) Pwm_Config=
{
   /** @brief Number of configured Pwm channels */
    ...
    equal to total number of available channels on FTM IPV */
    {
        ...
        (Pwm_ChannelType)255, (Pwm_ChannelType)255, (Pwm_ChannelType)255, (Pwm_ChannelType)2, (Pwm_ChannelType)255, (Pwm_ChannelType)255, (Pwm_ChannelType)255, (Pwm_ChannelType)255,
