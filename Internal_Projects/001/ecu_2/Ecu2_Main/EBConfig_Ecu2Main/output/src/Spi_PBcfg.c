...
static VAR(Spi_Ipw_LPspiDeviceAttributesConfigType, SPI_VAR) LPspiDeviceAttributesConfig_PB[1] =
{
                
        {
            ...
            LPSPI_TCR_PRESCALE_1_U32 /* Baudrate: Should=6000000.0, Is=5714285, Error=-4.76% */
          ...
          | 
            ...
            ((uint32)(39) << 16u) | /* TimeCs2Clk: Should=1000ns, Is=1000, Error=0.0% */
            ((uint32)(39) << 8u) | /* TimeCs2Cs: Should=1000ns, Is=1000, Error=0.0% */
            ((uint32)(5))
            ),
