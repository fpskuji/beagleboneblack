...
#define PWM_CFG_SW_PATCH_VERSION                  4
/**@}*/
...
*
*/
#define PWM_SET_PHASE_SHIFT_TIMEBASE_API        (STD_OFF)
...
*/
#define PwmCh_EnA                        ((Pwm_ChannelType)0U)
#define PwmCh_EnB                        ((Pwm_ChannelType)1U)
#define PwmCh_Servo                        ((Pwm_ChannelType)2U)

/** 
* @brief           Symbolic Names for configured channels - ecuc 2108 compliant.
*/

#define  PwmConf_PwmChannelConfigSet_PwmCh_EnA         ((Pwm_ChannelType)0U)
#define  PwmConf_PwmChannelConfigSet_PwmCh_EnB         ((Pwm_ChannelType)1U)
#define  PwmConf_PwmChannelConfigSet_PwmCh_Servo         ((Pwm_ChannelType)2U)
