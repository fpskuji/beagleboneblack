...
volatile float32 RPM_1;
// uint32 read = 0;
volatile float32 RPM_2;
volatile uint32 counter_1 = 0;
volatile uint32 counter_2 = 0;
volatile float32 time_interval;

extern boolean FLeft ;
extern boolean FRight ;
extern boolean Reverse;
extern boolean Break ;
...
float32 kphReading(float32 rpm)
{
    ...
    return (KPH < 0.0) ? (KPH - KPH - KPH) : (KPH);
}