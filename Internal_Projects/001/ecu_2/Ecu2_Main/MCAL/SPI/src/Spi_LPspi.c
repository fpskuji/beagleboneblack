...
#define SPI_SW_PATCH_VERSION_LPSPI_C                 4
...
)
{
    ...
    VAR(uint8, AUTOMATIC) LPspi_u8HWoffset = LPspi_pDev->LPspi_pcHWUnitConfig->u8Offset;
    ...
    if (NULL_PTR != Spi_pcSpiConfigPtr)
    {
        ...
        if (0u != LPspi_u32IsrStatus)
        {
            ...
            else
            {
                ...
                {
                    /* Disable Transmit and Receive Data Enable */
                    /*
                    * @violates @ref Spi_LPspi_c_REF_3 A cast should not be performed between a pointer
                    *     type and an integral type.
                    */
                    ...
                    * @violates @ref Spi_LPspi_c_REF_12 A cast should not be performed between a pointer type and an integral type.
                    */
                    REG_RMW32(LPSPI_DER_ADDR32(LPspi_u8HWoffset), (LPSPI_DER_RDDE_MASK_U32 | LPSPI_DER_TDDE_MASK_U32), 0x00UL);
                    /* finish job transfer */
    ...
    )
{
    ...
    */
    ...
    if (0u != LPspi_pDev->LPspi_pcHWUnitConfig->u16UseDma)
    {
        ...
        * @violates @ref Spi_LPspi_c_REF_12 A cast should not be performed between a pointer type and an integral type.
        */
        REG_WRITE32(LPSPI_DER_ADDR32(LPspi_pDev->LPspi_pcHWUnitConfig->u8Offset), (uint32)(LPSPI_DER_RDDE_MASK_U32 | LPSPI_DER_TDDE_MASK_U32));
    }
    else
#endif /* (SPI_DMA_USED == STD_ON) */
    {
    ...
    */
    ...
    if(SPI_SLAVE == LPspi_pDev->LPspi_pcHWUnitConfig->eSpiPhyUnitMode)
    {
        ...
        if (0u != LPspi_pDev->LPspi_pcHWUnitConfig->u16UseDma)
        {
            ...
            * @violates @ref Spi_LPspi_c_REF_12 A cast should not be performed between a pointer type and an integral type.
            */
            REG_RMW32(LPSPI_DER_ADDR32(LPspi_pcHWUnitConfig->u8Offset), (LPSPI_DER_RDDE_MASK_U32 | LPSPI_DER_TDDE_MASK_U32), 0x00UL);
        }
        else
        {
            /* Do nothing */
