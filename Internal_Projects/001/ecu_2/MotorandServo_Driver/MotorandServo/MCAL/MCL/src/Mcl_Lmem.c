...
#define MCL_LMEM_SW_PATCH_VERSION_C             4
...
#ifndef DISABLE_MCAL_INTERMODULE_ASR_CHECK
    #if ((MCL_LMEM_AR_RELEASE_MAJOR_VERSION_C != SCHM_MCL_AR_RELEASE_MAJOR_VERSION) || \
         (MCL_LMEM_AR_RELEASE_MINOR_VERSION_C != SCHM_MCL_AR_RELEASE_MINOR_VERSION) \
        )
            #error "AutoSar Version Numbers of Mcl_Lmem.c and SchM_Mcl.h are different"
    #endif
#endif
...
/* Check if source file and CDD_Mcl_Cfg.h header file are of the same Autosar version */
     ...
     (MCL_LMEM_AR_RELEASE_REVISION_VERSION_C != MCL_AR_RELEASE_REVISION_VERSION_CFG) \
    )
...
/* Check if source file and Mcl_Lmem.h header file are of the same Autosar version */
     ...
     (MCL_LMEM_AR_RELEASE_REVISION_VERSION_C != MCL_LMEM_AR_RELEASE_REVISION_VERSION) \
    )
...
/* Check if source file and Reg_eSys_Lmem.h header file are of the same Autosar version */
     ...
     (MCL_LMEM_AR_RELEASE_REVISION_VERSION_C != LMEM_AR_RELEASE_REVISION_VERSION_REG) \
    )
...
/* Check if source file and Reg_eSys_Lmem.h header file are of the same Autosar version */
     ...
     (MCL_LMEM_AR_RELEASE_REVISION_VERSION_C != MCL_LMEM_TYPES_AR_RELEASE_REVISION_VERSION) \
    )
